...
Header.prototype.render = function () {
  ...
  if (editor) {
    ...
    var markupPath = originalPath
      ? blessed.escape(path.relative(self.slap.fileBrowser.items()[0].path, originalPath))
      : "new file";
    ...
    var right = [(cursor.y+1)+","+(cursor.x+1) + " ("+editor.renderableLines().length+")", markupEncoding];
